...
from api.model.Speaker import Speaker, SpeakerModelSchema
from api import db
  ...
  # This api updates,deletes and gets single speaker information
    ...
    def put(self, id):
        ...
        if speaker:
            ...
            speaker.email = request.json['email']
            speaker.phone = request.json['phone']
            speaker.company_name = request.json['company_name']
            speaker.job_title = request.json['job_title']
